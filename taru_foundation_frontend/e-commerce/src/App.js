  ...
  return (
    <div className="wholepage">
      ...
      <nav className="navbar navbar-expand-xl sticky-top navbar-dark bg-dark homepage mr-auto">
        <div className="container-fluid">
          <a className="navbar-brand" href="/">
            <img src={"https://cdn.discordapp.com/attachments/989473099386847237/990368013616308234/unknown.png"} className="bg-white me-3" style={{ width: "48px" }} ></img>
            Taru Foundaton</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="uploadImg">Sell</NavLink>
              </li>
      ...
      <Routes>
        ...
        <Route path="uploadImg" element={<SellersHome />} />
